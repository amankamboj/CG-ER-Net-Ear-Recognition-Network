...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            saver.restore(sess,'./models/siamese/Ear_new_rot/model-Ear_new_rot.ckpt-680')
...
def load_data(image_paths):
    ...
    for i in range(no_of_images):
        current_file = cv2.imread(image_paths[i])
        current_image = cv2.resize(current_file,(300,450))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--data_dir', type=str,
        ...
        default='/media/user/DATA/matching/IITK/train_mod2')
    ...
    parser.add_argument('--people_per_batch', type=int,
        help='Number of people per batch.', default=106)
    ...
    parser.add_argument('--model_def', type=str,
        help='Model definition. Points to a module containing the definition of the inference graph.', default='models.siamese')
