...
classifier=load_model('./Inception_Results/ear_inception.h5py')
...
images = [[0 for x in range(3)] for y in range(125)]
...
for i in s :
    ...
    for p in range(1,poses+1):
        ...
        current_pose=cv2.resize(current_pose,(299,299))
        ...
        print('k',k)
        print('l',l)    
        images[k][l]=np.reshape(current_pose, [1,299, 299, 3])
