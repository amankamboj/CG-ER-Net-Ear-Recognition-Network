...
def main(args):
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            f = open('IITK_ear_after_right_roi'+subdir+'.txt', 'w')
...
def parse_arguments(argv):
    ...
    parser.add_argument('--model', type=str,
        help='Could be either a directory containing the meta_file and ckpt_file or a model protobuf (.pb) file',default='./models/siamese/Ear_new_rot')
    parser.add_argument('--data_dir', type=str,
        help='Path to the data directory',default='/media/user/DATA/matching/IITK/Test_Mod_IITK3')
